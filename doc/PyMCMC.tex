...
\code{store{[}`gamma'{]}}.  This feature is not used in this example, but can
...
\item Line 39 defines the class instance of \code{MCMC}. Note that the Gibbs sampler
...
and is saved in the file \code{'SSVS.out'}.
