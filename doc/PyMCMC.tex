...
\item filename: A string providing the name of an output file for the
  ...
  pdf, ps, eps and svg (see the documentation for \pkg{Matplotlib} for
...
\pkg{Numpy}, \pkg{Scipy} and \pkg{Matplotlib}: see \citet{NumpyScipy, Matplotlib} for further details of these
Python libraries.
...
There are many functions from the \proglang{R} statistical
language \citet{R} that can be useful in Bayesian analysis. The \pkg{RPy2} \proglang{Python} library can be
used to integrate \proglang{R} functions into \pkg{PyMCMC} programs. These can
