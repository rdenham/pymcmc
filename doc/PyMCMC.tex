...
The marginal posterior densities of these estimates (Figure
\ref{fig:plot_output_eg2}) confirm that both estimates are far from
zero. The ACF plots (Figure \ref{fig:plot_output_eg2}) and low inefficiency
...
Summary plots generated using \code{ms.plot(`rho')} (Figure
\ref{Flo:AR1}) provide the marginal posterior density,
